...
public class FeedforwardNeuralNetwork2 implements GameController {
...
//		[w1,1; w1,2; w2,1; w2,2; B1; B2; w1,o; w2,o; Bo]
	...
	public FeedforwardNeuralNetwork2(int hiddenDim, double[] values) {
...
//		O método getNeuralNetwork() retorna um vetor que representa o conjunto de pesos e biases da rede em um único vetor unidimensional. Como o que é recebido no segundo constrtutor.
	...
	public int getIndividuoSize() {
		this.INDIVIDUO_SIZE = inputDim * hiddenDim + hiddenDim + hiddenDim * outputDim + outputDim;
